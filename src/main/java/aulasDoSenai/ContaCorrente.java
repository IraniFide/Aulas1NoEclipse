...
public class ContaCorrente {
    ...
    public String getDataOcorrencia_cc() {
        return dataOcorrencia_cc;
    }
    public void setDataOcorrencia_cc(String dataOcorrencia_cc) {
        this.dataOcorrencia_cc = dataOcorrencia_cc;
    }
    private String dataOcorrencia_cc;
